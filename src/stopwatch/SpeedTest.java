...
public class SpeedTest {
	...
	public static void testAppendToString(int count) {
            timer.measureAndPrint(new AppendToStringTask(count));
	}
	...
	public static void testAppendToStringBuilder(int count ) {
            timer.measureAndPrint(new AppendToStringBuilderTask(count));
	}
	...
	public static void testSumDoublePrimitive(int counter) {
            timer.measureAndPrint(new SumDoublePrimitiveTask(counter));
	}
	...
	public static void testSumDouble(int counter) {
            timer.measureAndPrint(new SumDoubleTask(counter));
	}
	...
	public static void testSumBigDecimal(int counter) {
            timer.measureAndPrint(new SumBigDecimalTask(counter));
	}
